//! Embedded Hangzhou demo road graph + A* with hard avoid of circular zones.
//! Demo region: Hangzhou West Lake area (approx 30.20–30.32°N, 120.08–120.22°E).
//! Coordinates treated as the active CRS of the deployment (GCJ-02 when Gaode path).
...
mod tests {
    use super::*;
    use crate::geo::validate_polyline_vs_circles;
